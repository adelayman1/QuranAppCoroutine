...
@AndroidEntryPoint
class SurahDetailsFragment : Fragment(), IVerseItemClick {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        adapter = VerseAdapter(allVersesList, this)
                ...
                launch {
                    viewModel.verseList.collect {
                        when (it.statues) {
                            ...
                            ERROR -> Toast.makeText(requireContext(), it.error, Toast.LENGTH_SHORT)
                                .show()
                        }
    ...
    override fun OnPlayClickListener(audioLink: String) {
        if (mediaPlayer != null)
            return
